...
class Stokes_Brinkman_solver:

    def __init__(self, type_obstacle="square", n=None, R=None, Re=None):
    ...
    def Stokes_Brinkman_solve(self, mesh=None, W=None, obstacle=None, f_custom=None, u_exact=None, p_exact=None, g_custom=None):
        """
        Solves the stationary Stokes problem using Brinkman volume penalization.
        ...
        if obstacle is not None:
            ...
            if self.type_obstacle in ["cylinder", "circle"]:
...
def solve_stokes_brinkman_initial(mesh=None, W=None, obstacle=None, type_obstacle="square", n=None, Re=None, R=None, u_exact=None, p_exact=None, f_custom=None, g_custom=None):
    solver = Stokes_Brinkman_solver(type_obstacle=type_obstacle, n=n, Re=Re, R=R)
    return solver.Stokes_Brinkman_solve(mesh=mesh, W=W, obstacle=obstacle, f_custom=f_custom, u_exact=u_exact, p_exact=p_exact, g_custom=g_custom)
