...
- **`validation/`**: contiene gli script dedicati alle analisi numeriche e di benchmark:
  - **`Experiments/`**: raccoglie gli script per eseguire gli esperimenti con il meccanismo di buffer, utili a testare e validare i metodi immersi nel recupero dello stato della soluzione (es. Brinkman, RIIS, DLM).
